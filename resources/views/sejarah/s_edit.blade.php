	...
	<div class="container">
	  ...
	  {{ csrf_field() }}
	    ...
	    <div class="form-group row">
		 ...
		 <div class="form-group row">
			<label for="map" class="col-2 col-form-label">Address</label>
			<div class="col">
				...
				<div class="row">
					<div class="col">
						...
						<input type="text" name="lng" value="{{ $sejarah->sj_lng }}" id="lng"  class="form-control">
					</div>
					<div class="col">
						<label for="lag" class="col col-form-label">lat</label>
						<input type="text" name="lat" id="lat" value="{{ $sejarah->sj_lat }}"  class="form-control">
					</div>
				</div>	
			</div>
		</div>
